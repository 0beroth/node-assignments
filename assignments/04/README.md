# Assignment 4: Prompt User
* Copy your script from assigment 3 but update it to prompt the user instead of requiring an argument.
```
Example:
$ node index.js
please enter a search query: pilipili sc2
[
  {
